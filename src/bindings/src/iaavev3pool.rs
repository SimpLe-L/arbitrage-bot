...
interface IAaveV3Pool {
    function flashLoanSimple(address receiver, address asset, uint256 amount, bytes memory params, uint16 referralCode) external;
}
```
...
```*/
    ...
    impl IAaveV3PoolCalls {
        ...
        pub const SELECTORS: &'static [[u8; 4usize]] = &[[66u8, 176u8, 183u8, 124u8]];
    }
    #[automatically_derived]
